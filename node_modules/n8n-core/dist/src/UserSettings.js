...
function getUserN8nFolderDowloadedNodesPath() {
    return path_1.default.join(getUserN8nFolderPath(), _1.DOWNLOADED_NODES_SUBDIRECTORY);
}
exports.getUserN8nFolderDowloadedNodesPath = getUserN8nFolderDowloadedNodesPath;
