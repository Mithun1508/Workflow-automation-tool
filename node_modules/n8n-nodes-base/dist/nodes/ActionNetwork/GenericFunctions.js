...
function adjustLanguagesSpoken(allFields) {
    if (!allFields.languages_spoken)
        return allFields;
    return {
        ...(0, lodash_1.omit)(allFields, ['languages_spoken']),
...
function adjustPhoneNumbers(allFields) {
    if (!allFields.phone_numbers)
        return allFields;
    return {
        ...(0, lodash_1.omit)(allFields, ['phone_numbers']),
...
function adjustPostalAddresses(allFields) {
    ...
    if (allFields.postal_addresses.postal_addresses_fields.length) {
        const adjusted = allFields.postal_addresses.postal_addresses_fields.map((field) => {
            const copy = {
                ...(0, lodash_1.omit)(field, ['address_lines', 'location']),
            };
        ...
        return {
            ...(0, lodash_1.omit)(allFields, ['postal_addresses']),
...
function adjustLocation(allFields) {
    ...
    const adjusted = {
        ...(0, lodash_1.omit)(locationFields, ['address_lines', 'location']),
    };
    ...
    return {
        ...(0, lodash_1.omit)(allFields, ['location']),
        location: adjusted,
    };
}
function adjustTargets(allFields) {
    ...
    return {
        ...(0, lodash_1.omit)(allFields, ['target']),
        target: adjusted,
    };
}
...
const simplifyResponse = (response, resource) => {
    ...
    return {
        ...
        ...(0, lodash_1.omit)(response, fieldsToSimplify),
    };
};
...
const simplifyPersonResponse = (response) => {
    ...
    return {
        ...
        ...{
            postal_address: {
                ...(postalAddress && (0, lodash_1.omit)(postalAddress[0], 'address_lines')),
