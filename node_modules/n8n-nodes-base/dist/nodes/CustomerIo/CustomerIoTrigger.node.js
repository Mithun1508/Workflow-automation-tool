            ...
            default: {
                async checkExists() {
                    ...
                    for (const webhook of webhooks) {
                        if (webhook.endpoint === webhookUrl && (0, GenericFunctions_1.eventExists)(currentEvents, webhook.events)) {
                ...
                async create() {
                    ...
                    webhook = await GenericFunctions_1.customerIoApiRequest.call(this, 'POST', endpoint, body, 'beta');
                    const webhookData = this.getWorkflowStaticData('node');
                    webhookData.webhookId = webhook.id;
                    return true;
                },
