        ...
        for (let i = 0; i < items.length; i++) {
            try {
                ...
                if (resource === 'file' && operation === 'upload') {
                    ...
                    if (returnAll === true) {
                        data = (simple === true) ? (0, GenericFunctions_1.simplify)(responseData) : responseData;
                    }
                    else {
                        data = (simple === true) ? (0, GenericFunctions_1.simplify)(responseData[property]) : responseData[property];
                    }
                    const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(data), { itemData: { item: i } });
                    returnData.push(...executionData);
                }
