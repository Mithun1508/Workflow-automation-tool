...
class GmailTrigger {
    ...
    async poll() {
        ...
        let responseData;
        const now = Math.floor(luxon_1.DateTime.now().toSeconds()) + '';
        ...
        try {
            ...
            n8n_workflow_1.LoggerProxy.error(`There was a problem in '${node.name}' node in workflow '${workflow.id}': '${error.description}'`, {
                node: node.name,
