            ...
            try {
                ...
                if (resource === 'message') {
                    ...
                    if (operation === 'reply') {
                        ...
                        const options = this.getNodeParameter('options', i);
                        responseData = await GenericFunctions_1.replayToEmail.call(this, items, messageIdGmail, options, i);
                    }
                    if (operation === 'get') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        const qs = {};
                        Object.assign(qs, GenericFunctions_1.prepareQuery.call(this, filters), options);
                        if (returnAll) {
                ...
                if (resource === 'draft') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        qs.format = 'raw';
                        for (let i = 0; i < responseData.length; i++) {
                            responseData[i] = await GenericFunctions_1.googleApiRequest.call(this, 'GET', `/gmail/v1/users/me/drafts/${responseData[i].id}`, {}, qs);
                            const dataPropertyNameDownload = options.dataPropertyAttachmentsPrefixName || 'attachment_';
                ...
                if (resource === 'thread') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        const filters = this.getNodeParameter('filters', i);
                        const qs = {};
                        Object.assign(qs, GenericFunctions_1.prepareQuery.call(this, filters));
                        if (returnAll) {
