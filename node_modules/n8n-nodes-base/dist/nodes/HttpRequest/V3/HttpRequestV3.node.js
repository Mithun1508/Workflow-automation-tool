...
class HttpRequestV3 {
                                    ...
                                    values: [
                                        {
                                            ...
                                            type: 'boolean',
                                            default: false,
                                            description: 'Whether to return the full reponse (headers and response status code) data instead of only the body',
                                        },
                                        {
    ...
    async execute() {
        ...
        for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
            ...
            if (((_e = redirect === null || redirect === void 0 ? void 0 : redirect.redirect) === null || _e === void 0 ? void 0 : _e.followRedirects) !== false) {
                requestOptions.followRedirect = true;
                requestOptions.followAllRedirects = true;
            }
            if ((_f = redirect === null || redirect === void 0 ? void 0 : redirect.redirect) === null || _f === void 0 ? void 0 : _f.maxRedirects) {
            ...
            if (((_h = response === null || response === void 0 ? void 0 : response.response) === null || _h === void 0 ? void 0 : _h.neverError) === true) {
            ...
            const parmetersToKeyValue = async (acc, cur) => {
                var _a;
                const acumulator = await acc;
                if (cur.parameterType === 'formBinaryData') {
                    const binaryDataOnInput = (_a = items[itemIndex]) === null || _a === void 0 ? void 0 : _a.binary;
                    if (!cur.inputDataFieldName)
                        return acumulator;
                    if (!(binaryDataOnInput === null || binaryDataOnInput === void 0 ? void 0 : binaryDataOnInput[cur.inputDataFieldName])) {
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), `Input Data Field Name '${cur.inputDataFieldName}' could not be found in input`, {
                            runIndex: itemIndex,
                        });
                    }
                    if (!cur.inputDataFieldName)
            ...
            if (sendHeaders && headerParameters) {
                if (specifyHeaders === 'keypair') {
                    ...
                    requestOptions.headers = (0, n8n_workflow_1.jsonParse)(jsonHeadersParameter);
                }
            }
        ...
        for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
            ...
            const fullResponse = this.getNodeParameter('options.response.response.fullResponse', 0, false);
            if (autoDetectResponseFormat) {
                const responseContentType = (_j = response.headers['content-type']) !== null && _j !== void 0 ? _j : '';
                if (responseContentType.includes('application/json')) {
                    responseFormat = 'json';
                    response.body = (0, n8n_workflow_1.jsonParse)(Buffer.from(response.body).toString());
                }
            ...
            if (responseFormat === 'file') {
                const outputPropertyName = this.getNodeParameter('outputPropertyName', 0, 'data');
                const newItem = {
                    json: {},
                    binary: {},
                    pairedItem: {
