            ...
            if (operation === 'splitOutItems') {
                ...
                if (aggregate === 'aggregateIndividualFields') {
                    ...
                    for (const { fieldToAggregate, outputFieldName, renameField } of fieldsToAggregate) {
                        ...
                        const getFieldToAggregate = () => disableDotNotation === false && fieldToAggregate.includes('.')
                ...
                if (type === 'simple') {
                    ...
                    newItems.sort((a, b) => {
                        ...
                        for (const field of sortFieldsWithDirection) {
                            let equal;
                            if (disableDotNotation === false) {
                                const _a = typeof (0, lodash_1.get)(a.json, field.name) === 'string'
                                    ? (0, lodash_1.get)(a.json, field.name).toLowerCase()
                                    : (0, lodash_1.get)(a.json, field.name);
                                const _b = typeof (0, lodash_1.get)(b.json, field.name) === 'string'
                                    ? (0, lodash_1.get)(b.json, field.name).toLowerCase()
                                    : (0, lodash_1.get)(b.json, field.name);
