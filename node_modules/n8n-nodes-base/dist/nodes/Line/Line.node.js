                        ...
                        if (body.imageUi) {
                            ...
                            if (image && image.binaryData === true) {
                                ...
                                if (items[i].binary[image.binaryProperty] === undefined) {
                                    throw new n8n_workflow_1.NodeOperationError(this.getNode(), `No binary data property "${image.binaryProperty}" does not exists on item!`, { itemIndex: i });
                                }
                                const binaryData = items[i].binary[image.binaryProperty];
                                const binaryDataBuffer = await this.helpers.getBinaryDataBuffer(i, image.binaryProperty);
                                body.imageFile = {
