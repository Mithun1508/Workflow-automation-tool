            ...
            loadOptions: {
                async getProjects() {
                    try {
                        ...
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), `Error while fetching projects! (${e})`);
                    }
                },
                async getTables() {
                    ...
                    if (projectId) {
                        try {
                            ...
                            throw new n8n_workflow_1.NodeOperationError(this.getNode(), `Error while fetching tables! (${e})`);
                        }
                    }
                    else {
                        ...
                        for (const field of fields) {
                            if (!field.binaryData) {
                                ...
                                if (binaryPropertyName && !items[i].binary[binaryPropertyName]) {
                                    throw new n8n_workflow_1.NodeOperationError(this.getNode(), `Binary property ${binaryPropertyName} does not exist on item!`, { itemIndex: i });
                                }
                                ...
                                responseData = await GenericFunctions_1.apiRequest.call(this, 'POST', postUrl, {}, qs, undefined, {
                                    formData,
                                });
