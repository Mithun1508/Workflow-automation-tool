...
function getPropertyKeyValue(value, type, timezone, version = 1) {
    ...
    switch (type) {
        ...
        case 'relation':
            result = {
                type: 'relation',
                relation: value.relationValue.reduce((acc, cur) => {
...
function getConditions() {
    ...
    for (const type of Object.keys(types)) {
        elements.push({
            ...
            options: typeConditions[types[type]].map((type) => ({
