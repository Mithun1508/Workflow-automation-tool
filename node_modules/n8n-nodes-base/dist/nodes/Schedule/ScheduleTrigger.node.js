                    ...
                    options: [
                        {
                            ...
                            values: [
                                ...
                                {
                                    displayName: 'You can find help generating your cron expression <a href="http://www.cronmaker.com/?1" target="_blank">here</a>',
                                    name: 'notice',
                                    type: 'notice',
                                    displayOptions: {
                                        show: {
    ...
    async trigger() {
        ...
        for (let i = 0; i < interval.length; i++) {
            ...
            if (interval[i].field === 'cronExpression') {
                ...
                try {
                    const cronJob = new cron_1.CronJob(cronExpression, executeTrigger, undefined, true, timezone);
            ...
            if (interval[i].field === 'hours') {
                const hour = (_a = interval[i].hoursInterval) === null || _a === void 0 ? void 0 : _a.toString();
                const minute = (_b = interval[i].triggerAtMinute) === null || _b === void 0 ? void 0 : _b.toString();
            ...
            if (interval[i].field === 'days') {
                const day = (_c = interval[i].daysInterval) === null || _c === void 0 ? void 0 : _c.toString();
            ...
            if (interval[i].field === 'weeks') {
                const hour = (_f = interval[i].triggerAtHour) === null || _f === void 0 ? void 0 : _f.toString();
                const minute = (_g = interval[i].triggerAtMinute) === null || _g === void 0 ? void 0 : _g.toString();
                const week = interval[i].weeksInterval;
                const days = interval[i].triggerAtDay;
                const day = days.length === 0 ? '*' : days.join(',');
                const cronTimes = [minute, hour, `*/${week * 7}`, '*', day];
                const cronExpression = cronTimes.join(' ');
                const cronJob = new cron_1.CronJob(cronExpression, executeTrigger, undefined, true, timezone);
                cronJobs.push(cronJob);
            }
            if (interval[i].field === 'months') {
                const month = (_h = interval[i].monthsInterval) === null || _h === void 0 ? void 0 : _h.toString();
                const day = (_j = interval[i].triggerAtDayOfMonth) === null || _j === void 0 ? void 0 : _j.toString();
                const hour = (_k = interval[i].triggerAtHour) === null || _k === void 0 ? void 0 : _k.toString();
                const minute = (_l = interval[i].triggerAtMinute) === null || _l === void 0 ? void 0 : _l.toString();
                const cronTimes = [minute, hour, day, `*/${month}`, '*'];
                const cronExpression = cronTimes.join(' ');
                const cronJob = new cron_1.CronJob(cronExpression, executeTrigger, undefined, true, timezone);
                cronJobs.push(cronJob);
            }
