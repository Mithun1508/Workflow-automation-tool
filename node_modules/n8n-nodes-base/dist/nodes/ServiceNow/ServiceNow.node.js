                ...
                if (resource === 'attachment') {
                    if (operation === 'get') {
                        ...
                        if (items[i].binary && items[i].binary[inputDataFieldName]) {
                            ...
                            throw new n8n_workflow_1.NodeOperationError(this.getNode(), `No binary data property "${inputDataFieldName}" does not exists on item!`, { itemIndex: i });
                        }
                        const headers = {
                        ...
                        const response = await GenericFunctions_1.serviceNowApiRequest.call(this, 'POST', '/now/attachment/file', body, qs, '', { headers });
                        responseData = response.result;
                    }
