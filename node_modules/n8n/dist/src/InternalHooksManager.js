...
class InternalHooksManager {
    ...
    static init(instanceId, versionCli, nodeTypes) {
        if (!this.internalHooksInstance) {
            this.internalHooksInstance = new InternalHooks_1.InternalHooksClass(new telemetry_1.Telemetry(instanceId, versionCli), instanceId, versionCli, nodeTypes);
        }
        return this.internalHooksInstance;
    }
}
exports.InternalHooksManager = InternalHooksManager;
//# sourceMappingURL=InternalHooksManager.js.map