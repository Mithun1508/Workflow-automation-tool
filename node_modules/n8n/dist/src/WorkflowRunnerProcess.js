...
class WorkflowRunnerProcess {
    ...
    async runWorkflow(inputData) {
        ...
        additionalData.executeWorkflow = async (workflowInfo, additionalData, options) => {
            ...
            const runData = await _1.WorkflowExecuteAdditionalData.getRunData(workflowData, additionalData.userId, options === null || options === void 0 ? void 0 : options.inputData, options === null || options === void 0 ? void 0 : options.parentWorkflowId);
