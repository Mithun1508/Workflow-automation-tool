...
class CreateUserManagement1646992772331 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_${tablePrefixPure}65a0933c0f19d278881653bf81d35064" ON ${tablePrefix}shared_workflow ("workflowId");`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_${tablePrefixPure}829d16efa0e265cb076d50eca8d21733" ON ${tablePrefix}shared_credentials ("credentialsId");`);
