...
class UpdateWorkflowCredentials1630330987096 {
    ...
    async up(queryRunner) {
		...
		`;
        await (0, migrationHelpers_2.runInBatches)(queryRunner, workflowsQuery, (workflows) => {
		...
		`;
        await (0, migrationHelpers_2.runInBatches)(queryRunner, waitingExecutionsQuery, (waitingExecutions) => {
